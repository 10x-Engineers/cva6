...
# DVE full session
# Saved on Wed Jan 24 17:48:06 2024
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 168} {height 427} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 168} {height 427} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1365} {height 173} {dock_state bottom} {dock_on_new_line true}}
