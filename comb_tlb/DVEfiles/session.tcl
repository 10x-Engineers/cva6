...
# DVE full session
# Saved on Tue Feb 27 16:23:49 2024
# Designs open: 1
...
#   Group count = 3
#   Group comb_tlb_vif signal count = 13
#   Group shared_tlb_vif signal count = 11
#   Group tlb_vif signal count = 8
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 146} {height 330} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 329
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 249} {height 330} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1365} {height 270} {dock_state bottom} {dock_on_new_line true}}
...
catch {gui_list_select -id ${Hier.1} {top.comb_tlb_vif}}
