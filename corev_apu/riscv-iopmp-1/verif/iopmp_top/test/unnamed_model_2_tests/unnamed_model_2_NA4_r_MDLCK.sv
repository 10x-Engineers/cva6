class unnamed_model_2_NA4_r_MDLCK extends unnamed_model_2_base_test;
  `uvm_component_utils(unnamed_model_2_NA4_r_MDLCK)
  ...
  function new(string name = "unnamed_model_2_NA4_r_MDLCK", uvm_component parent = null);
