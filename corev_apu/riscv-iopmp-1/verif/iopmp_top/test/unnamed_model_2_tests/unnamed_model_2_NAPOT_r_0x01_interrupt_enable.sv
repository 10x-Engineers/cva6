class unnamed_model_2_NAPOT_r_0x01_interrupt_enable extends unnamed_model_2_base_test;
  `uvm_component_utils(unnamed_model_2_NAPOT_r_0x01_interrupt_enable)
  ...
  function new(string name = "unnamed_model_2_NAPOT_r_0x01_interrupt_enable", uvm_component parent = null);
