class unnamed_model_2_NA4_x_MDCFGLCK_error extends unnamed_model_2_base_test;
  `uvm_component_utils(unnamed_model_2_NA4_x_MDCFGLCK_error)
  ...
  function new(string name = "unnamed_model_2_NA4_x_MDCFGLCK_error", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      mdcfglck.wdata = 32'h8;
      mdcfglck.start(env.ahb_env.ahb_agnt.ahb_sqr);

      // locking the mdcfglck register
      mdcfglck.wdata = 32'h9;
      mdcfglck.start(env.ahb_env.ahb_agnt.ahb_sqr);
      
      // trying to write the locked register
      mdcfglck.wdata = 32'h10;
      mdcfglck.start(env.ahb_env.ahb_agnt.ahb_sqr);
     ...
     // hwcfg2.prio_entry = 16
      ...
      // This transaction will be an error as no entry will be check in RAP
      #50ns;
      ar_seq.rrid      = 2;
      ar_seq.addr      = 364;
      ar_seq.id        = 3;
