class unnamed_model_2_NA4_x_0x03_error extends unnamed_model_2_base_test;
  `uvm_component_utils(unnamed_model_2_NA4_x_0x03_error)
  ...
  function new(string name = "unnamed_model_2_NA4_x_0x03_error", uvm_component parent = null);
