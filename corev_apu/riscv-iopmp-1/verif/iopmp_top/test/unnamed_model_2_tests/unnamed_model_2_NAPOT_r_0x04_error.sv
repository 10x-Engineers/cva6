class unnamed_model_2_NAPOT_r_0x04_error extends unnamed_model_2_base_test;
  `uvm_component_utils(unnamed_model_2_NAPOT_r_0x04_error)
  ...
  function new(string name = "unnamed_model_2_NAPOT_r_0x04_error", uvm_component parent = null);
