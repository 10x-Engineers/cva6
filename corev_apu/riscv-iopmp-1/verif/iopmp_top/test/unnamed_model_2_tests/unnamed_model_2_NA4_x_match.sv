class unnamed_model_2_NA4_x_match extends unnamed_model_2_base_test;
  `uvm_component_utils(unnamed_model_2_NA4_x_match)
  ...
  function new(string name = "unnamed_model_2_NA4_x_match", uvm_component parent = null);
