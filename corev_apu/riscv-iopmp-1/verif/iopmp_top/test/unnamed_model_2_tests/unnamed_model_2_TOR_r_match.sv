class unnamed_model_2_TOR_r_match extends unnamed_model_2_base_test;
  `uvm_component_utils(unnamed_model_2_TOR_r_match)
  ...
  function new(string name = "unnamed_model_2_TOR_r_match", uvm_component parent = null);
