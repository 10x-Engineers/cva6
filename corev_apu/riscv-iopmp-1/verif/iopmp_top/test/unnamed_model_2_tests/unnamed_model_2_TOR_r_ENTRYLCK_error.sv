class unnamed_model_2_TOR_r_ENTRYLCK_error extends unnamed_model_2_base_test;
  `uvm_component_utils(unnamed_model_2_TOR_r_ENTRYLCK_error)
  ...
  function new(string name = "unnamed_model_2_TOR_r_ENTRYLCK_error", uvm_component parent = null);
