class unnamed_model_2_NAPOT_x_match extends unnamed_model_2_base_test;
  `uvm_component_utils(unnamed_model_2_NAPOT_x_match)
  ...
  function new(string name = "unnamed_model_2_NAPOT_x_match", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      srcmdperm.wdata = 32'h40;                       // Traverse MD 3
      srcmdperm.index = 3;
