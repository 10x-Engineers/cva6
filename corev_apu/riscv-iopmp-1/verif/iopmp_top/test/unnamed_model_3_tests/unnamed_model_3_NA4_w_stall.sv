class unnamed_model_3_NA4_w_stall extends unnamed_model_3_base_test;
  `uvm_component_utils(unnamed_model_3_NA4_w_stall)
  ...
  function new(string name = "unnamed_model_3_NA4_w_stall", uvm_component parent = null);
