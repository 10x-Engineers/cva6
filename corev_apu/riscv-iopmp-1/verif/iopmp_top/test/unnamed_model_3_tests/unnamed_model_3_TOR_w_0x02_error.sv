class unnamed_model_3_TOR_w_0x02_error extends unnamed_model_3_base_test;
  `uvm_component_utils(unnamed_model_3_TOR_w_0x02_error)
  ...
  function new(string name = "unnamed_model_3_TOR_w_0x02_error", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'hA;                      // TOR address mode with write permission granted and read permission not granted
      entry_cfg.index = 0;
