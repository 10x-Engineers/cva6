class unnamed_model_3_TOR_w_ENTRYLCK_match extends unnamed_model_3_base_test;
  `uvm_component_utils(unnamed_model_3_TOR_w_ENTRYLCK_match)
  ...
  function new(string name = "unnamed_model_3_TOR_w_ENTRYLCK_match", uvm_component parent = null);
