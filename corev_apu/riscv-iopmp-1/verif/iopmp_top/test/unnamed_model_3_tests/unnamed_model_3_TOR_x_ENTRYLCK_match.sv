class unnamed_model_3_TOR_x_ENTRYLCK_match extends unnamed_model_3_base_test;
  `uvm_component_utils(unnamed_model_3_TOR_x_ENTRYLCK_match)
  ...
  function new(string name = "unnamed_model_3_TOR_x_ENTRYLCK_match", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
     ...
     // hwcfg2.prio_entry = 16
      ...
      // This transaction will be an match
      #50ns;
      ar_seq.rrid      = 2;
      ar_seq.addr      = 364;
      ar_seq.id        = 3;
