class unnamed_model_3_NA4_w_MDLCK extends unnamed_model_3_base_test;
  `uvm_component_utils(unnamed_model_3_NA4_w_MDLCK)
  ...
  function new(string name = "unnamed_model_3_NA4_w_MDLCK", uvm_component parent = null);
