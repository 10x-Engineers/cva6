class unnamed_model_3_NAPOT_w_match extends unnamed_model_3_base_test;
  `uvm_component_utils(unnamed_model_3_NAPOT_w_match)
  ...
  function new(string name = "unnamed_model_3_NAPOT_w_match", uvm_component parent = null);
