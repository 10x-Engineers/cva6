class unnamed_model_3_NAPOT_r_0x01_error_interrupt_suppress extends unnamed_model_3_base_test;
  `uvm_component_utils(unnamed_model_3_NAPOT_r_0x01_error_interrupt_suppress)
  ...
  function new(string name = "unnamed_model_3_NAPOT_r_0x01_error_interrupt_suppress", uvm_component parent = null);
