class unnamed_model_1_NAPOT_x_0x03_interrupt_suppress extends unnamed_model_1_base_test;
  `uvm_component_utils(unnamed_model_1_NAPOT_x_0x03_interrupt_suppress)
  ...
  function new(string name = "unnamed_model_1_NAPOT_x_interrupt_suppress", uvm_component parent = null);
