class unnamed_model_1_TOR_r_ENTRYLCK_match extends unnamed_model_1_base_test;
  `uvm_component_utils(unnamed_model_1_TOR_r_ENTRYLCK_match)
  ...
  function new(string name = "unnamed_model_1_TOR_r_ENTRYLCK_match", uvm_component parent = null);
