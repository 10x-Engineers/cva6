class unnamed_model_1_NAPOT_x_0x03_error_interrupt_suppress extends unnamed_model_1_base_test;
  `uvm_component_utils(unnamed_model_1_NAPOT_x_0x03_error_interrupt_suppress)
  ...
  function new(string name = "unnamed_model_1_NAPOT_x_0x03_error_interrupt_suppress", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'h499;                     // NAPOT address mode with exe suppression and no permissions granted
      entry_cfg.index = 9;
