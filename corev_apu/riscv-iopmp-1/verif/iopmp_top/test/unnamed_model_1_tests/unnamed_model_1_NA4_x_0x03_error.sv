class unnamed_model_1_NA4_x_0x03_error extends unnamed_model_1_base_test;
  `uvm_component_utils(unnamed_model_1_NA4_x_0x03_error)
    entry_addr_reg_write entry_addr;
    entry_cfg_reg_write  entry_cfg;
    axi_req_seq          ar_seq;
    //  iopmp_env     env;

  function new(string name = "unnamed_model_1_NA4_x_0x03_error", uvm_component parent = null);
