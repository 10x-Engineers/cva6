class unnamed_model_1_NA4_r_stall extends unnamed_model_1_base_test;
  `uvm_component_utils(unnamed_model_1_NA4_r_stall)
  ...
  function new(string name = "unnamed_model_1_NA4_r_stall", uvm_component parent = null);
