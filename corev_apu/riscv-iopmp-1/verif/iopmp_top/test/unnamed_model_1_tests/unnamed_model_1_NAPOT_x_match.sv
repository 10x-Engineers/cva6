class unnamed_model_1_NAPOT_x_match extends unnamed_model_1_base_test;
  `uvm_component_utils(unnamed_model_1_NAPOT_x_match)
    entry_addr_reg_write entry_addr;
    entry_cfg_reg_write  entry_cfg;
    axi_req_seq_napot    ar_seq;
    //  iopmp_env     env;

  function new(string name = "unnamed_model_1_NAPOT_x_match", uvm_component parent = null);
