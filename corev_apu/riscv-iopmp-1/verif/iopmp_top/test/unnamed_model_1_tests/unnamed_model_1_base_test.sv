...
class unnamed_model_1_base_test extends uvm_test;
    `uvm_component_utils(unnamed_model_1_base_test)
    ...
    function new(string name = "unnamed_model_1_base_test", uvm_component parent = null);
