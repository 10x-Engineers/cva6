class rapid_k_model_NA4_r_0x01_interrupt_suppress extends rapid_k_model_base_test;
  `uvm_component_utils(rapid_k_model_NA4_r_0x01_interrupt_suppress)
  ...
  function new(string name = "rapid_k_model_NA4_r_0x01_interrupt_suppress", uvm_component parent = null);
