...
class rapid_k_model_NAPOT_x_MDLCK_error extends rapid_k_model_base_test;
  `uvm_component_utils(rapid_k_model_NAPOT_x_MDLCK_error)
  ...
  function new(string name = "rapid_k_model_NAPOT_x_MDLCK_error", uvm_component parent = null);
