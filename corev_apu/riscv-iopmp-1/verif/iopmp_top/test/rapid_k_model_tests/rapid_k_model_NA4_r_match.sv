class rapid_k_model_NA4_r_match extends rapid_k_model_base_test;
  `uvm_component_utils(rapid_k_model_NA4_r_match)
  ...
  function new(string name = "rapid_k_model_NA4_r_match", uvm_component parent = null);
