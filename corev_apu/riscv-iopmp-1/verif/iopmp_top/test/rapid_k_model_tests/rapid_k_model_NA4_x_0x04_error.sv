class rapid_k_model_NA4_x_0x04_error extends rapid_k_model_base_test;
  `uvm_component_utils(rapid_k_model_NA4_x_0x04_error)
  ...
  function new(string name = "rapid_k_model_NA4_x_0x04_error", uvm_component parent = null);
