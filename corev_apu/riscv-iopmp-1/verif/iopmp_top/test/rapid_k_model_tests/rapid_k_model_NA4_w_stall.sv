class rapid_k_model_NA4_w_stall extends rapid_k_model_base_test;
  `uvm_component_utils(rapid_k_model_NA4_w_stall)
  ...
  function new(string name = "rapid_k_model_NA4_w_stall", uvm_component parent = null);
