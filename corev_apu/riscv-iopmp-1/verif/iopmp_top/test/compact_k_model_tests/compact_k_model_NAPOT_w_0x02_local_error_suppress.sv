class compact_k_model_NAPOT_w_0x02_local_error_suppress extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_NAPOT_w_0x02_local_error_suppress)
  ...
  function new(string name = "compact_k_model_NAPOT_w_0x02_local_error_suppress", uvm_component parent = null);
