class compact_k_model_NAPOT_r_match extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_NAPOT_r_match)
    entry_addr_reg_write entry_addr;
    entry_cfg_reg_write  entry_cfg;
    axi_req_seq_napot    ar_seq;
    //  iopmp_env     env;

  function new(string name = "compact_k_model_NAPOT_r_match", uvm_component parent = null);
