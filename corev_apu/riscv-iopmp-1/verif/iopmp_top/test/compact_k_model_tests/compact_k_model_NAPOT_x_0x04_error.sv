class compact_k_model_NAPOT_x_0x04_error extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_NAPOT_x_0x04_error)
    entry_addr_reg_write entry_addr;
    entry_cfg_reg_write  entry_cfg;
    axi_req_seq_napot    ar_seq;
    //  iopmp_env     env;

  function new(string name = "compact_k_model_NAPOT_x_0x04_error", uvm_component parent = null);
