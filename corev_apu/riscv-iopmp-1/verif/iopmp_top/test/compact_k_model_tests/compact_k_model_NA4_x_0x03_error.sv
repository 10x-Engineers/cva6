class compact_k_model_NA4_x_0x03_error extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_NA4_x_0x03_error)
    entry_addr_reg_write entry_addr;
    entry_cfg_reg_write  entry_cfg;
    axi_req_seq          ar_seq;
    //  iopmp_env     env;

  function new(string name = "compact_k_model_NA4_x_0x03_error", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      // Illegal Instruction Fetch Error
