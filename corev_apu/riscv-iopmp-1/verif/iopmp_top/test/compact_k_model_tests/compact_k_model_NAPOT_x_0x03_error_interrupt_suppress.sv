class compact_k_model_NAPOT_x_0x03_error_interrupt_suppress extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_NAPOT_x_0x03_error_interrupt_suppress)
  ...
  function new(string name = "compact_k_model_NAPOT_x_0x03_error_interrupt_suppress", uvm_component parent = null);
