class compact_k_model_NA4_w_0x02_error extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_NA4_w_0x02_error)
  ...
  function new(string name = "compact_k_model_NA4_w_0x02_error", uvm_component parent = null);
