class compact_k_model_TOR_x_ENTRYLCK_error extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_TOR_x_ENTRYLCK_error)
  ...
  function new(string name = "compact_k_model_TOR_x_ENTRYLCK_error", uvm_component parent = null);
