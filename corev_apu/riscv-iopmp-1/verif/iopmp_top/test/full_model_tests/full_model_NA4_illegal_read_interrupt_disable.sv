/*************************************************************************
   > File Name:   full_model_NA4_illegal_read_interrupt_disable.sv
   > Description: 
   ...
   3. Send a read transaction that must generate 0x01 error.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_read_interrupt_disable extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_read_interrupt_disable)
  ...
  function new(string name = "full_model_NA4_illegal_read_interrupt_disable", uvm_component parent = null);
