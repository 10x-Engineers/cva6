class full_model_NAPOT_r_match extends full_model_base_test;
  `uvm_component_utils(full_model_NAPOT_r_match)
  ...
  function new(string name = "full_model_NAPOT_r_match", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      mdcfg.wdata = 64'h300000000;                  // 5 entries associated with this md   entry 0,1,2,3,4
      mdcfg.index = 3;
