/*************************************************************************
   > File Name:   full_model_r_perm_write_test.sv
   > Description: Send write address for Full MOdel with NA4 Addressing mode with r permission in entry_cfg.
   1. Configure full address match with no write permission.
   2. Corresponding SRCMD_W bit is 0.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_r_perm_write_test extends full_model_base_test;
  `uvm_component_utils(full_model_r_perm_write_test)
  ...
  function new(string name = "full_model_r_perm_write_test", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
     ...
     // hwcfg2.prio_entry = 16
      ...
      err_cfg.b_data = 32'h4030A;      // MSI EN, MSI DATA Set
