class full_model_w_ENTRYLCK_match extends full_model_base_test;
  `uvm_component_utils(full_model_w_ENTRYLCK_match)
  ...
  function new(string name = "full_model_w_ENTRYLCK_match", uvm_component parent = null);
