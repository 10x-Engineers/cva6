/*************************************************************************
   > File Name:   full_model_NA4_illegal_read_mfr_en_multiple_rrid_read_err_info_test.sv
   > Description: 
   ...
   3. Send a read request on ERR_INFO to check the ERR_INFO.v and ERR_INFO.svc bit.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_read_mfr_en_multiple_rrid_read_err_info_test extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_read_mfr_en_multiple_rrid_read_err_info_test)
  ...
  function new(string name = "full_model_NA4_illegal_read_mfr_en_multiple_rrid_read_err_info_test", uvm_component parent = null);
