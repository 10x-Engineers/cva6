/*************************************************************************
   > File Name:   test_ad2_r0_w0_x0_mdstall.sv
...
12. Write all zero's on MDSTALL register
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_r0_w0_x0_mdstall extends full_model_base_test;
  `uvm_component_utils(test_ad2_r0_w0_x0_mdstall)
  ...
  function new(string name = "test_ad2_r0_w0_x0_mdstall", uvm_component parent = null);
