/*************************************************************************
   > File Name:   full_model_NA4_illegal_read_mfr_dis_multi_err_test.sv
   > Description: Send MULTIPLE read address for Full MOdel with NA4 Addressing mode with no permission in entry_cfg such that rrid get error at window 0. Enable MFR.
   1. Configure the IOPMP Registers.
   2. Generate subsequent violation error for multiple RRIDs by sending multiple ERROR transaction to the IOPMP.
   ERR_MFR_EN -> 0
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_read_mfr_dis_multi_err_test extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_read_mfr_dis_multi_err_test)
  ...
  function new(string name = "full_model_NA4_illegal_read_mfr_dis_multi_err_test", uvm_component parent = null);
