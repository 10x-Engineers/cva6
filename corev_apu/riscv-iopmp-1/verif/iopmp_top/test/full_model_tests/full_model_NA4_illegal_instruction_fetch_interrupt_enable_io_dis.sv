/*************************************************************************
   > File Name:   full_model_NA4_illegal_instruction_fetch_interrupt_enable_io_dis.sv
   > Description: Send instruction fetch for Full MOdel with NA4 Addressing mode with no permission in entry_cfg. Enable interrupt enable bit in error capture register then check if interrupt is reported or not.  Disable IOPMP enable hwcfg0.enable=0.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_instruction_fetch_interrupt_enable_io_dis extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_instruction_fetch_interrupt_enable_io_dis)
  ...
  function new(string name = "full_model_NA4_illegal_instruction_fetch_interrupt_enable_io_dis", uvm_component parent = null);
