class full_model_NA4_w_stall_r_nonstall extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_w_stall_r_nonstall)
  ...
  function new(string name = "full_model_NA4_w_stall_r_nonstall", uvm_component parent = null);
