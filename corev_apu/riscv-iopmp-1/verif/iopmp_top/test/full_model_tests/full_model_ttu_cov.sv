/*************************************************************************
   > File Name:   full_model_ttu_cov.sv
...
class full_model_ttu_cov extends full_model_base_test;
  `uvm_component_utils(full_model_ttu_cov)
  ...
  function new(string name = "full_model_ttu_cov", uvm_component parent = null);
