class full_model_x_ENTRYLCK_error extends full_model_base_test;
  `uvm_component_utils(full_model_x_ENTRYLCK_error)
  ...
  function new(string name = "full_model_x_ENTRYLCK_error", uvm_component parent = null);
