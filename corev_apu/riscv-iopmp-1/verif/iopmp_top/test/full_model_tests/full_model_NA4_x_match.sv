class full_model_NA4_x_match extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_x_match)
  ...
  function new(string name = "full_model_NA4_x_match", uvm_component parent = null);
