/*************************************************************************
   > File Name:   full_model_cfg_x_disable.sv
   > Description: Send read address with prot b100 for Full MOdel with NA4 Addressing mode by disabling x permission in entry_cfg.
   1. Configure full address match and entry with execute=0.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_cfg_x_disable extends full_model_base_test;
  `uvm_component_utils(full_model_cfg_x_disable)
  ...
  function new(string name = "full_model_cfg_x_disable", uvm_component parent = null);
