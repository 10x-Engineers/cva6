class full_model_x_0x03_error_interrupt_suppress extends full_model_base_test;
  `uvm_component_utils(full_model_x_0x03_error_interrupt_suppress)
  ...
  function new(string name = "full_model_x_0x03_error_interrupt_suppress", uvm_component parent = null);
