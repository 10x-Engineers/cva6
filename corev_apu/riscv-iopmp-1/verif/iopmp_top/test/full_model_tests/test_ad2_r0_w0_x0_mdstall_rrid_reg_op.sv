/*************************************************************************
   > File Name:   test_ad2_r0_w0_x0_mdstall_rrid_reg_op.sv
...
12. Write all zero's on MDSTALL register
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_r0_w0_x0_mdstall_rrid_reg_op extends full_model_base_test;
  `uvm_component_utils(test_ad2_r0_w0_x0_mdstall_rrid_reg_op)
  ...
  function new(string name = "test_ad2_r0_w0_x0_mdstall_rrid_reg_op", uvm_component parent = null);
...
//FOR RRID = 5
      ...
      join_any
      #100;
      rridscp.b_data    = 32'h00000005;
      rridscp.start(env.axi_env.rd_addr_agnt.rd_addr_sqr);

      rridscp.b_data    = 32'h40000002;
      rridscp.start(env.axi_env.rd_addr_agnt.rd_addr_sqr);
