/*************************************************************************
   > File Name:   full_model_NA4_illegal_instruction_fetch_interrupt_disable.sv
   > Description: 
   ...
   3. Send an instruction fetch transaction that must generate 0x03 error.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_instruction_fetch_interrupt_disable extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_instruction_fetch_interrupt_disable)
  ...
  function new(string name = "full_model_NA4_illegal_instruction_fetch_interrupt_disable", uvm_component parent = null);
