class full_model_NA4_r_stall_w_nonstall extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_r_stall_w_nonstall)
  ...
  function new(string name = "full_model_NA4_r_stall_w_nonstall", uvm_component parent = null);
