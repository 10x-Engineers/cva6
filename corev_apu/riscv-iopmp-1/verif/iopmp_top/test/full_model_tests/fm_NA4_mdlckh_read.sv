/*************************************************************************
   > File Name:   fm_NA4_mdlckh_read.sv
   > Description: Send read address for Full MOdel with NA4 Addressing mode with r permission in entry_cfg. INitially don't set the MDLCK. Set f=4 in MDLCK after setting srcmden = 8 and mdcfg 5. After this try to set srcmden = 4. Then set mdlck = D. 
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_mdlckh_read extends full_model_base_test;
    `uvm_component_utils(fm_NA4_mdlckh_read)
    ...
    function new(string name = "fm_NA4_mdlckh_read", uvm_component parent = null);
