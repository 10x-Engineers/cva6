/*************************************************************************
   > File Name:   full_model_NA4_rw_perm_read.sv
   > Description: Send read address for Full MOdel with NA4 Addressing mode with rw permission in entry_cfg.
...
class full_model_NA4_rw_perm_read extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_rw_perm_read)
  ...
  function new(string name = "full_model_NA4_rw_perm_read", uvm_component parent = null);
