/*************************************************************************
   > File Name:   full_model_NA4_illegal_instruction_fetch_interrupt_enable.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_instruction_fetch_interrupt_enable extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_instruction_fetch_interrupt_enable)
  ...
  function new(string name = "full_model_NA4_illegal_instruction_fetch_interrupt_enable", uvm_component parent = null);
