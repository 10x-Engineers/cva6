class full_model_x_0x03_interrupt_enable extends full_model_base_test;
  `uvm_component_utils(full_model_x_0x03_interrupt_enable)
  ...
  function new(string name = "full_model_x_0x03_interrupt_enable", uvm_component parent = null);
