/*************************************************************************
   > File Name:   full_model_NA4_sps_dis_x_perm_instruction_fetch_test.sv
   > Description: Send instruction fetch for Full MOdel with NA4 Addressing mode with x permission in entry_cfg.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_sps_dis_x_perm_instruction_fetch_test extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_sps_dis_x_perm_instruction_fetch_test)
  ...
  function new(string name = "full_model_NA4_sps_dis_x_perm_instruction_fetch_test", uvm_component parent = null);
