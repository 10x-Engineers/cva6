/*************************************************************************
   > File Name:   full_model_NA4_illegal_read_mfr_en_multiple_rrid_test.sv
   > Description: 
   ...
   3. Send a read request to ERR_MFR Register.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_read_mfr_en_multiple_rrid_test extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_read_mfr_en_multiple_rrid_test)
  ...
  function new(string name = "full_model_NA4_illegal_read_mfr_en_multiple_rrid_test", uvm_component parent = null);
