/*************************************************************************
   > File Name:   full_model_NA4_illegal_read_mfr_en_interrupt_enable_msi_werr_wr_err_info.sv
   > Description:
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_read_mfr_en_interrupt_enable_msi_werr_wr_err_info extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_read_mfr_en_interrupt_enable_msi_werr_wr_err_info)
  ...
  function new(string name = "full_model_NA4_illegal_read_mfr_en_interrupt_enable_msi_werr_wr_err_info", uvm_component parent = null);
