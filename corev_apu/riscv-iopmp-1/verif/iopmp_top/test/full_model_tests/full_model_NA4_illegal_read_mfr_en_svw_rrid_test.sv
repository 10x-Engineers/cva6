/*************************************************************************
   > File Name:   full_model_NA4_illegal_read_mfr_en_svw_rrid_test.sv
   ...
   2. Send a read/write/instruction fetch transaction that must generate some error with RRID 0-15.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_read_mfr_en_svw_rrid_test extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_read_mfr_en_svw_rrid_test)
  ...
  function new(string name = "full_model_NA4_illegal_read_mfr_en_svw_rrid_test", uvm_component parent = null);
