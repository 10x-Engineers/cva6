class full_model_no_x_enable extends full_model_base_test;
  `uvm_component_utils(full_model_no_x_enable)
  ...
  function new(string name = "full_model_no_x_enable", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      // NOT HIT ANY RULE error as chk_x and no_x are set
      #50ns;
      ar_seq.rrid      = 32;
      ar_seq.addr      = 364;
      ar_seq.id        = 3;
