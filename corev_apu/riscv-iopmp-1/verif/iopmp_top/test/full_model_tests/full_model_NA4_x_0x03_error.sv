class full_model_NA4_x_0x03_error extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_x_0x03_error)
  ...
  function new(string name = "full_model_NA4_x_0x03_error", uvm_component parent = null);
