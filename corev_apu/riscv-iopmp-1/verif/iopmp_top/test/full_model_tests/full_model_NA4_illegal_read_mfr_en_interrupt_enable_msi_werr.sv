/*************************************************************************
   > File Name:   full_model_NA4_illegal_read_mfr_en_interrupt_enable_msi_werr.sv
   > Description:
   ...
   5. Send the same error transaction again.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_read_mfr_en_interrupt_enable_msi_werr extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_read_mfr_en_interrupt_enable_msi_werr)
  ...
  function new(string name = "full_model_NA4_illegal_read_mfr_en_interrupt_enable_msi_werr", uvm_component parent = null);
