/*************************************************************************
   > File Name:   full_model_NA4_illegal_read_mfr_en_svw_3_rrid_test.sv
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_read_mfr_en_svw_3_rrid_test extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_read_mfr_en_svw_3_rrid_test)
  ...
  function new(string name = "full_model_NA4_illegal_read_mfr_en_svw_3_rrid_test", uvm_component parent = null);
