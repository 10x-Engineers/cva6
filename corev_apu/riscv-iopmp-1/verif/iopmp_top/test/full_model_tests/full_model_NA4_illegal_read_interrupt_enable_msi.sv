/*************************************************************************
   > File Name:   full_model_NA4_illegal_read_interrupt_enable_msi.sv
   > Description: Send read address for Full MOdel with NA4 Addressing mode with no permission in entry_cfg. Also Enable interrupt enable and msi_en bit in error capture register then check if interrupt is reported or not.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_read_interrupt_enable_msi extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_read_interrupt_enable_msi)
  ...
  function new(string name = "full_model_NA4_illegal_read_interrupt_enable_msi", uvm_component parent = null);
