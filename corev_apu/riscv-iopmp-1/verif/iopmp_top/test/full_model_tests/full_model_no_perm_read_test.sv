/*************************************************************************
   > File Name:   full_model_no_perm_read_test.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_no_perm_read_test extends full_model_base_test;
  `uvm_component_utils(full_model_no_perm_read_test)
  ...
  function new(string name = "full_model_no_perm_read_test", uvm_component parent = null);
