/*************************************************************************
   > File Name:   full_model_NA4_rw_perm_write_no_w_enable.sv
   > Description: Send write address for Full MOdel with NA4 Addressing mode with rw permission in entry_cfg. Enable no_w in hwcfg0 register
   >              Set NO_W -> 1
...
class full_model_NA4_rw_perm_write_no_w_enable extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_rw_perm_write_no_w_enable)
  ...
  function new(string name = "full_model_NA4_rw_perm_write_no_w_enable", uvm_component parent = null);
