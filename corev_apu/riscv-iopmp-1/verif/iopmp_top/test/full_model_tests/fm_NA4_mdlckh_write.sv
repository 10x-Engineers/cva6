/*************************************************************************
   > File Name:   fm_NA4_mdlckh_write.sv
   > Description: Send write address for Full MOdel with NA4 Addressing mode with rw permission in entry_cfg. INitially don't set the MDLCK. Set f=4 in MDLCK after setting srcmden = 8 and mdcfg 5. After this try to set srcmden = 4. Then set mdlck = D. 
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_mdlckh_write extends full_model_base_test;
    `uvm_component_utils(fm_NA4_mdlckh_write)
    hwcfg0_reg_seq         hwcfg0;
    srcmdenh_reg_seq       srcmden;
    srcmdwh_reg_seq        srcmdw;
    ...
    function new(string name = "fm_NA4_mdlckh_write", uvm_component parent = null);
        ...
        srcmdw      = srcmdwh_reg_seq::type_id::create("srcmdw");
