class full_model_w_0x02_local_error_suppress extends full_model_base_test;
  `uvm_component_utils(full_model_w_0x02_local_error_suppress)
  ...
  function new(string name = "full_model_w_0x02_local_error_suppress", uvm_component parent = null);
