/*************************************************************************
   > File Name:   fm_NA4_PP_mdstall.sv
   > Description: Send read address for Full Model with NA4 Addressing mode with no permission in entry_cfg. Select MDs BY SETTING md field in MDSTALL reg. Then send read transaction again.
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_PP_mdstall extends full_model_base_test;
  `uvm_component_utils(fm_NA4_PP_mdstall)
  ...
  function new(string name = "fm_NA4_PP_mdstall", uvm_component parent = null);
