/*************************************************************************
   > File Name:   full_model_NA4_w_perm_write.sv
   > Description: Send write address for Full MOdel with NA4 Addressing mode with w permission in entry_cfg.
   1. Configure full address match and entry permissions with write=1.
   2. Corresponding SRCMD_R=0 and SRCMD_W=1.
...
class full_model_NA4_w_perm_write extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_w_perm_write)
  ...
  function new(string name = "full_model_NA4_w_perm_write", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      #50;
      aw_seq.rrid       = 32;   //aw-wuser
      aw_seq.seq_addr   = 364;  //aw-addr
      aw_seq.seq_id     = 3;    //aw-id
      aw_seq.seq_size   = 4;    //aw-size
      aw_seq.data_size  = 16;   //Assign Data size to be written
      ...
      aw_seq_data.data_size  = 16;    //Assign Data size to be written
