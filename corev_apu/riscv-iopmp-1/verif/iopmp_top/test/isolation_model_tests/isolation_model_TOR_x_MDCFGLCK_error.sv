class isolation_model_TOR_x_MDCFGLCK_error extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_TOR_x_MDCFGLCK_error)
  ...
  function new(string name = "isolation_model_TOR_x_MDCFGLCK_error", uvm_component parent = null);
