class isolation_model_NAPOT_w_0x02_error_suppress extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_NAPOT_w_0x02_error_suppress)
  ...
  function new(string name = "isolation_model_NAPOT_w_0x02_error_suppress", uvm_component parent = null);
