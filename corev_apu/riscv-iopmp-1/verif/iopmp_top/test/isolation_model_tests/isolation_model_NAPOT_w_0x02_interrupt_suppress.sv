class isolation_model_NAPOT_w_0x02_interrupt_suppress extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_NAPOT_w_0x02_interrupt_suppress)
  ...
  function new(string name = "isolation_model_NAPOT_w_0x02_interrupt_suppress", uvm_component parent = null);
