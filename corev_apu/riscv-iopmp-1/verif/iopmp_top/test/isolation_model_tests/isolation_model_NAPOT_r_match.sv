class isolation_model_NAPOT_r_match extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_NAPOT_r_match)
  ...
  function new(string name = "isolation_model_NAPOT_r_match", uvm_component parent = null);
