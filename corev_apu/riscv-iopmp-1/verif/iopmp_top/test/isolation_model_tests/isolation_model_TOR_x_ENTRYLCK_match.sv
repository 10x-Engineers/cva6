class isolation_model_TOR_x_ENTRYLCK_match extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_TOR_x_ENTRYLCK_match)
  ...
  function new(string name = "isolation_model_TOR_x_ENTRYLCK_match", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'hC;                      // TOR address mode with instruction permission granted
      entry_cfg.index = 3;
