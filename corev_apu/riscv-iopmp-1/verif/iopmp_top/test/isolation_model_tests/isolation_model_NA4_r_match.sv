class isolation_model_NA4_r_match extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_NA4_r_match)
  ...
  function new(string name = "isolation_model_NA4_r_match", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      mdcfg.wdata = 32'h3;                          // 3 entries are associated with this MD  entry 0,1,2
      mdcfg.index = 32;
      ...
      entry_cfg.wdata = 32'h11;                     // NA4 address mode with read permission granted
      entry_cfg.index = 2;
