class isolation_model_NAPOT_w_0x04_error extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_NAPOT_w_0x04_error)
  ...
  function new(string name = "isolation_model_NAPOT_w_0x04_error", uvm_component parent = null);
