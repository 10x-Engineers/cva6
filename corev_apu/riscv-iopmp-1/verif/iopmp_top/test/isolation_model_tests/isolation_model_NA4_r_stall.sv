class isolation_model_NA4_r_stall extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_NA4_r_stall)
  ...
  function new(string name = "isolation_model_NA4_r_stall", uvm_component parent = null);
