class dynamic_k_model_NA4_x_0x04_error extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_x_0x04_error)
  ...
  function new(string name = "dynamic_k_model_NA4_x_0x04_error", uvm_component parent = null);
