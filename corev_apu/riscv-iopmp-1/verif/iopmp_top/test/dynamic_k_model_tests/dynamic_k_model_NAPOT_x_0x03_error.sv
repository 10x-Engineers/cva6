class dynamic_k_model_NAPOT_x_0x03_error extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NAPOT_x_0x03_error)
  ...
  function new(string name = "dynamic_k_model_NAPOT_x_0x033_error", uvm_component parent = null);
