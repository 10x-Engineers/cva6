class dynamic_k_model_NA4_r_0x01_local_error_suppress extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_r_0x01_local_error_suppress)
  ...
  function new(string name = "dynamic_k_model_NA4_r_0x01_local_error_suppress", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'h110;                     // NA4 address mode with no permission granted
      entry_cfg.index = 9;
