class dynamic_k_model_TOR_w_0x02_error extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_TOR_w_0x02_error)
  ...
  function new(string name = "dynamic_k_model_TOR_w_0x02_error", uvm_component parent = null);
