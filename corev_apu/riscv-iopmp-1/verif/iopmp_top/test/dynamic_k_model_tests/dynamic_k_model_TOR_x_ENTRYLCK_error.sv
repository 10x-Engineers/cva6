class dynamic_k_model_TOR_r_ENTRYLCK_error extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_TOR_r_ENTRYLCK_error)
  ...
  function new(string name = "dynamic_k_model_TOR_r_ENTRYLCK_error", uvm_component parent = null);
