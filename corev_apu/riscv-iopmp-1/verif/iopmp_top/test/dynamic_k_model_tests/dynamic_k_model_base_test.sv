...
class dynamic_k_model_base_test extends uvm_test;
    `uvm_component_utils(dynamic_k_model_base_test)
    ...
    function new(string name = "dynamic_k_model_base_test", uvm_component parent = null);
