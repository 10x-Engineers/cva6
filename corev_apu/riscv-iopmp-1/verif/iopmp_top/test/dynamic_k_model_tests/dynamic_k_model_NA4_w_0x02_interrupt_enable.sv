class dynamic_k_model_NA4_w_0x02_interrupt_enable extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_w_0x02_interrupt_enable)
  ...
  function new(string name = "dynamic_k_model_NA4_w_0x02_interrupt_enable", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      // PEIS is disbaled
      entry_cfg.wdata = 32'h10;                     // NA4 address mode and no permissions granted
      entry_cfg.index = 9;
