/*************************************************************************
   > File Name:   test_ad2_cross_region.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_cross_region extends base_test;
  `uvm_component_utils(test_ad2_cross_region)
  ...
  function new(string name = "test_ad2_cross_region", uvm_component parent = null);
