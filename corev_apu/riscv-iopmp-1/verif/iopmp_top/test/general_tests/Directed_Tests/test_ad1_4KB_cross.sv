/*************************************************************************
   > File Name:   test_ad1_4KB_cross.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad1_4KB_cross extends base_test;
  `uvm_component_utils(test_ad1_4KB_cross)
  ...
  function new(string name = "test_ad1_4KB_cross", uvm_component parent = null);
