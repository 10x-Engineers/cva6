/*************************************************************************
   > File Name:   test_ad1_cross_region.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad1_cross_region extends base_test;
  `uvm_component_utils(test_ad1_cross_region)
  ...
  function new(string name = "test_ad1_cross_region", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    ...
    `endif
      ...
      if(t_type==0)begin
        ...
        aw_seq.data_size  = data_size+4;     //Assign Data size to be written
