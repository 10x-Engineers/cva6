/*************************************************************************
   > File Name:   test_ad2_interpt_sup.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_interpt_sup extends base_test;
  `uvm_component_utils(test_ad2_interpt_sup)
  ...
  function new(string name = "test_ad2_interpt_sup", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    ...
    msi_data       = 10;        //Error capture field 
    ...
    `endif
      ...
      ent_addr();       //Entry_Addr
      ent_cfg(lwr_entry, {x_perm,w_perm,r_perm}, ad_mode, 6'b000111);
