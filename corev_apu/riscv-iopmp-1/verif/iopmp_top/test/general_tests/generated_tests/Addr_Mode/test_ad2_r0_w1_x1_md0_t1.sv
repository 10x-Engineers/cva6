/*************************************************************************
   > File Name:   test_ad2_r0_w1_x1_md0_t1.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_r0_w1_x1_md0_t1 extends base_test;
  `uvm_component_utils(test_ad2_r0_w1_x1_md0_t1)
  ...
  function new(string name = "test_ad2_r0_w1_x1_md0_t1", uvm_component parent = null);
