/*************************************************************************
   > File Name:   test_ad0_r1_w0_x0_md0_t1.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad0_r1_w0_x0_md0_t1 extends base_test;
  `uvm_component_utils(test_ad0_r1_w0_x0_md0_t1)
  ...
  function new(string name = "test_ad0_r1_w0_x0_md0_t1", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    ...
    r_perm         = 1;          //high this bit for read perm
    w_perm         = 0;          //high this bit for write perm
    x_perm         = 0;          //high this bit for instruction fetch perm
    ad_mode        = 0;         //OFF=0, TOR=1, NA4=2, NAPOT=3
    t_type         = 1;              //transaction type 0= read, 1 = write, 2 = instruction fetch
