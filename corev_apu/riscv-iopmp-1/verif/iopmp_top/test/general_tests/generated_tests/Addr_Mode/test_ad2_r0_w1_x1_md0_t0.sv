/*************************************************************************
   > File Name:   test_ad2_r0_w1_x1_md0_t0.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_r0_w1_x1_md0_t0 extends base_test;
  `uvm_component_utils(test_ad2_r0_w1_x1_md0_t0)
  ...
  function new(string name = "test_ad2_r0_w1_x1_md0_t0", uvm_component parent = null);
