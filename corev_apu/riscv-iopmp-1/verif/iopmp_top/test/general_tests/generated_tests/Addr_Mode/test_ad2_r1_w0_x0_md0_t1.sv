/*************************************************************************
   > File Name:   test_ad2_r1_w0_x0_md0_t1.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_r1_w0_x0_md0_t1 extends base_test;
  `uvm_component_utils(test_ad2_r1_w0_x0_md0_t1)
  ...
  function new(string name = "test_ad2_r1_w0_x0_md0_t1", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    ...
    ad_mode        = 2;         //OFF=0, TOR=1, NA4=2, NAPOT=3
