/*************************************************************************
   > File Name:   test_ad3_r1_w0_x0_md0_t2.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad3_r1_w0_x0_md0_t2 extends base_test;
  `uvm_component_utils(test_ad3_r1_w0_x0_md0_t2)
  ...
  function new(string name = "test_ad3_r1_w0_x0_md0_t2", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    ...
    ad_mode        = 3;         //OFF=0, TOR=1, NA4=2, NAPOT=3
    t_type         = 2;              //transaction type 0= read, 1 = write, 2 = instruction fetch
