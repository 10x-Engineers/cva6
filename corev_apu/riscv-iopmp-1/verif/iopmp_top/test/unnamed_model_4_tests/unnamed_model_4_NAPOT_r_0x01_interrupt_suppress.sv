class unnamed_model_4_NAPOT_r_0x01_interrupt_suppress extends unnamed_model_4_base_test;
  `uvm_component_utils(unnamed_model_4_NAPOT_r_0x01_interrupt_suppress)
  ...
  function new(string name = "unnamed_model_4_NAPOT_r_0x01_interrupt_suppress", uvm_component parent = null);
