class unnamed_model_4_NAPOT_x_0x04_error extends unnamed_model_4_base_test;
  `uvm_component_utils(unnamed_model_4_NAPOT_x_0x04_error)
  ...
  function new(string name = "unnamed_model_4_NAPOT_x_0x04_error", uvm_component parent = null);
