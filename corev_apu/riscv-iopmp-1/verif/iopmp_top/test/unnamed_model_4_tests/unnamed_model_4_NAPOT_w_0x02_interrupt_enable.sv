class unnamed_model_4_NAPOT_w_0x02_interrupt_enable extends unnamed_model_4_base_test;
  `uvm_component_utils(unnamed_model_4_NAPOT_w_0x02_interrupt_enable)
  ...
  function new(string name = "unnamed_model_4_NAPOT_w_0x02_interrupt_enable", uvm_component parent = null);
