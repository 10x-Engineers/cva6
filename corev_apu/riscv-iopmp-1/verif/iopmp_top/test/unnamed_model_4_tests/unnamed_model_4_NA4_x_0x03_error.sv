class unnamed_model_4_NA4_x_0x03_error extends unnamed_model_4_base_test;
  `uvm_component_utils(unnamed_model_4_NA4_x_0x03_error)
  ...
  function new(string name = "unnamed_model_4_NA4_x_0x03_error", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'h10;                     // NA4 address mode with no permission granted
      entry_cfg.index = 17;
