class unnamed_model_4_NA4_x_MDLCK extends unnamed_model_4_base_test;
  `uvm_component_utils(unnamed_model_4_NA4_x_MDLCK)
  ...
  function new(string name = "unnamed_model_4_NA4_x_MDLCK", uvm_component parent = null);
