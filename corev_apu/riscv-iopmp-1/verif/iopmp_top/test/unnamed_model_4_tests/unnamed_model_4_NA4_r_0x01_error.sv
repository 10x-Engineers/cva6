class unnamed_model_4_NA4_r_0x01_error extends unnamed_model_4_base_test;
  `uvm_component_utils(unnamed_model_4_NA4_r_0x01_error)
  ...
  function new(string name = "unnamed_model_4_NA4_r_0x01_error", uvm_component parent = null);
