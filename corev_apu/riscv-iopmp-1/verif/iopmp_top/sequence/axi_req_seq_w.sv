/*************************************************************************
   ...
   > Description: Sequence implementation for Master AXI4 VIP write addr channel.
...
class axi_req_seq_w extends uvm_sequence #(axi_seq_item);
    `uvm_object_utils(axi_req_seq_w) // Register with the UVM factory
    ...
    // Constructor
    function new(string name = "axi_req_seq_w");
      super.new(name);
    endfunction
