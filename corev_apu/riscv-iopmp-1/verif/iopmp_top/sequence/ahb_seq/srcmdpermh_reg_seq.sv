...
class srcmdpermh_reg_seq extends ahb_base_seq;
    `uvm_object_utils(srcmdpermh_reg_seq)
        // iopmp_reg regmodel;
        // uvm_status_e   status;
        bit [31:0] index;
        uvm_reg_addr_t addr;
    ...
    function new(string name = "srcmdpermh_reg_seq");
        super.new(name);
    endfunction
