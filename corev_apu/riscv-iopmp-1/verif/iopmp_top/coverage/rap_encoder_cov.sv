  ...
  rap_cover_prio_entry_0_op: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && (!`RAP_ENCODER.entry_operation[0][1]) && `RAP_ENCODER.prio_entries[0]) |-> (`RAP_ENCODER.operation_o == `RAP_ENCODER.entry_operation[0]))
  );
  ...
  rap_cover_prio_entry_1_op: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && `RAP_ENCODER.entry_operation[0][1] && (!`RAP_ENCODER.entry_operation[1][1]) && `RAP_ENCODER.prio_entries[1]) |-> (`RAP_ENCODER.operation_o == `RAP_ENCODER.entry_operation[1]))
  );
  ...
  rap_cover_prio_entry_2_op: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && `RAP_ENCODER.entry_operation[1][1] && `RAP_ENCODER.entry_operation[0][1] && (!`RAP_ENCODER.entry_operation[2][1]) &&
  ...
  rap_cover_prio_entry_3_op: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && `RAP_ENCODER.entry_operation[2][1] && `RAP_ENCODER.entry_operation[1][1] && `RAP_ENCODER.entry_operation[0][1] &&
    (!`RAP_ENCODER.entry_operation[3][1]) && `RAP_ENCODER.prio_entries[3]) |-> (`RAP_ENCODER.operation_o == `RAP_ENCODER.entry_operation[3]))
  );
  ...
  rap_cover_prio_entry_4_op: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && `RAP_ENCODER.entry_operation[3][1] && `RAP_ENCODER.entry_operation[2][1] && `RAP_ENCODER.entry_operation[1][1] &&
    `RAP_ENCODER.entry_operation[0][1] && (!`RAP_ENCODER.entry_operation[4][1]) && `RAP_ENCODER.prio_entries[4]) |-> (`RAP_ENCODER.operation_o == `RAP_ENCODER.entry_operation[4]))
  );
  ...
  rap_cover_prio_entry_5_op: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && `RAP_ENCODER.entry_operation[4][1] && `RAP_ENCODER.entry_operation[3][1] && `RAP_ENCODER.entry_operation[2][1] &&
    `RAP_ENCODER.entry_operation[1][1] && `RAP_ENCODER.entry_operation[0][1] && (!`RAP_ENCODER.entry_operation[5][1]) && `RAP_ENCODER.prio_entries[5]) |-> (`RAP_ENCODER.operation_o == `RAP_ENCODER.entry_operation[5]))
  );
  ...
  rap_cover_prio_entry_6_op: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && `RAP_ENCODER.entry_operation[5][1] && `RAP_ENCODER.entry_operation[4][1] && `RAP_ENCODER.entry_operation[3][1] && `RAP_ENCODER.entry_operation[2][1] &&
    `RAP_ENCODER.entry_operation[1][1] && `RAP_ENCODER.entry_operation[0][1] && (!`RAP_ENCODER.entry_operation[6][1]) && `RAP_ENCODER.prio_entries[6]) |-> (`RAP_ENCODER.operation_o == `RAP_ENCODER.entry_operation[6]))
  );
  ...
  rap_cover_prio_entry_7_op: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && `RAP_ENCODER.entry_operation[6][1] && `RAP_ENCODER.entry_operation[5][1] && `RAP_ENCODER.entry_operation[4][1] && `RAP_ENCODER.entry_operation[3][1] &&
    `RAP_ENCODER.entry_operation[2][1] && `RAP_ENCODER.entry_operation[1][1] && `RAP_ENCODER.entry_operation[0][1] && (!`RAP_ENCODER.entry_operation[7][1]) && `RAP_ENCODER.prio_entries[7]) |-> (`RAP_ENCODER.operation_o == `RAP_ENCODER.entry_operation[7]))
  );
  ...
  rap_cover_non_prio_entry_1_op_match: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && (`RAP_ENCODER.entry_operation[0][1] && `RAP_ENCODER.prio_entries[0]) && ((!`RAP_ENCODER.prio_entries[1]) && ((`RAP_ENCODER.entry_operation[1] == MATCHED) ||
    (`RAP_ENCODER.entry_operation[2] == MATCHED) || (`RAP_ENCODER.entry_operation[3] == MATCHED) || (`RAP_ENCODER.entry_operation[4] == MATCHED) || (`RAP_ENCODER.entry_operation[5] == MATCHED) ||
    (`RAP_ENCODER.entry_operation[6] == MATCHED) || (`RAP_ENCODER.entry_operation[7] == MATCHED)))) |-> (`RAP_ENCODER.operation_o == MATCHED))
  );
  ...
  rap_cover_non_prio_entry_2_op_match: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && (`RAP_ENCODER.entry_operation[0][1] && `RAP_ENCODER.entry_operation[1][1] && (&`RAP_ENCODER.prio_entries[1:0])) && ((!`RAP_ENCODER.prio_entries[2]) &&
    ((`RAP_ENCODER.entry_operation[2] == MATCHED) || (`RAP_ENCODER.entry_operation[3] == MATCHED) || (`RAP_ENCODER.entry_operation[4] == MATCHED) || (`RAP_ENCODER.entry_operation[5] == MATCHED) ||
    (`RAP_ENCODER.entry_operation[6] == MATCHED) || (`RAP_ENCODER.entry_operation[7] == MATCHED)))) |-> (`RAP_ENCODER.operation_o == MATCHED))
  );
  ...
  rap_cover_non_prio_entry_3_op_match: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && (`RAP_ENCODER.entry_operation[0][1] && `RAP_ENCODER.entry_operation[1][1] && `RAP_ENCODER.entry_operation[2][1] && (&`RAP_ENCODER.prio_entries[2:0]))
  ...
  rap_cover_non_prio_entry_4_op_match: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && (`RAP_ENCODER.entry_operation[0][1] && `RAP_ENCODER.entry_operation[1][1] && `RAP_ENCODER.entry_operation[2][1] &&
    `RAP_ENCODER.entry_operation[3][1] && (&`RAP_ENCODER.prio_entries[3:0])) && ((!`RAP_ENCODER.prio_entries[4]) && ((`RAP_ENCODER.entry_operation[4] == MATCHED) ||
  ...
  rap_cover_non_prio_entry_5_op_match: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && (`RAP_ENCODER.entry_operation[0][1] && `RAP_ENCODER.entry_operation[1][1] && `RAP_ENCODER.entry_operation[2][1] &&
    `RAP_ENCODER.entry_operation[3][1] && `RAP_ENCODER.entry_operation[4][1] && (&`RAP_ENCODER.prio_entries[4:0])) && ((!`RAP_ENCODER.prio_entries[5]) && ((`RAP_ENCODER.entry_operation[5] == MATCHED)
    || (`RAP_ENCODER.entry_operation[6] == MATCHED) || (`RAP_ENCODER.entry_operation[7] == MATCHED)))) |-> (`RAP_ENCODER.operation_o == MATCHED))
  );
  ...
  rap_cover_non_prio_entry_6_op_match: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && (`RAP_ENCODER.entry_operation[0][1] && `RAP_ENCODER.entry_operation[1][1] && `RAP_ENCODER.entry_operation[2][1] &&
    `RAP_ENCODER.entry_operation[3][1] && `RAP_ENCODER.entry_operation[4][1] && `RAP_ENCODER.entry_operation[5][1] && (&`RAP_ENCODER.prio_entries[5:0])) && ((!`RAP_ENCODER.prio_entries[6])
    && ((`RAP_ENCODER.entry_operation[6] == MATCHED) || (`RAP_ENCODER.entry_operation[7] == MATCHED)))) |-> (`RAP_ENCODER.operation_o == MATCHED))
  );
  ...
  rap_cover_non_prio_entry_7_op_match: cover property (
    @(posedge clk) (((`RAP_ENCODER.operation_i == SEARCH) && (`RAP_ENCODER.entry_operation[0][1] && `RAP_ENCODER.entry_operation[1][1] && `RAP_ENCODER.entry_operation[2][1] &&
    `RAP_ENCODER.entry_operation[3][1] && `RAP_ENCODER.entry_operation[4][1] && `RAP_ENCODER.entry_operation[5][1] && `RAP_ENCODER.entry_operation[6][1] && (&`RAP_ENCODER.prio_entries[6:0]))
