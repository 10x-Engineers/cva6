...
#(
  ...
  always_comb begin : register_read_path
    ...
    mux_b21_out = muxout (mux_b2_sel, ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL, {iopmp_reg.prog_prot_reg.mdstall.md, iopmp_reg.prog_prot_reg.mdstall.is_busy},
                          iopmp_reg.prog_prot_reg.mdstallh, {iopmp_reg.prog_prot_reg.rridscp.stat, 14'h0, iopmp_reg.prog_prot_reg.rridscp.rrid}, ILLEGAL);

    // CONFIGURATION PROTECTION registers MUX output
    mux_b22_out = muxout (mux_b2_sel, iopmp_reg.config_prot_reg.mdlck, iopmp_reg.config_prot_reg.mdlckh, {25'h0, iopmp_reg.config_prot_reg.mdcfglck},
                          {15'h0, iopmp_reg.config_prot_reg.entrylck}, ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL);

    // ERROR REPORTING registers MUX output
    mux_b23_out = muxout (mux_b2_sel, {13'h0, iopmp_reg.err_rpt_reg.err_cfg}, {23'h0, iopmp_reg.err_rpt_reg.err_info}, iopmp_reg.err_rpt_reg.err_reqaddr, {14'h0, iopmp_reg.err_rpt_reg.err_reqaddrh},
                          iopmp_reg.err_rpt_reg.err_reqid, err_mfr_rdata, iopmp_reg.err_rpt_reg.err_msiaddr, {12'h0, iopmp_reg.err_rpt_reg.err_msiaddrh});
    ...
    //
    // 16'h0 represent the reserved bits of mdcfg register and is concatenated with mdcfg.t field of each
    // register to get the 32 bit value of register on read
    //****************************************************************************************************
    if (CFG.MDCFG_FMT_0) begin : gen_mdcfg_fmt_0_read_path

      mux_m30_out = muxout (mux_m3_sel, {16'h0, iopmp_reg.mdcfg_table[0].t},  {16'h0, iopmp_reg.mdcfg_table[1].t}, {16'h0, iopmp_reg.mdcfg_table[2].t}, {16'h0, iopmp_reg.mdcfg_table[3].t},
                            {16'h0, iopmp_reg.mdcfg_table[4].t}, {16'h0, iopmp_reg.mdcfg_table[5].t}, {16'h0, iopmp_reg.mdcfg_table[6].t}, {16'h0, iopmp_reg.mdcfg_table[7].t});

      mux_m31_out = muxout (mux_m3_sel, {16'h0, iopmp_reg.mdcfg_table[8].t},  {16'h0, iopmp_reg.mdcfg_table[9].t}, {16'h0, iopmp_reg.mdcfg_table[10].t}, {16'h0, iopmp_reg.mdcfg_table[11].t},
                            {16'h0, iopmp_reg.mdcfg_table[12].t}, {16'h0, iopmp_reg.mdcfg_table[13].t}, {16'h0, iopmp_reg.mdcfg_table[14].t}, {16'h0, iopmp_reg.mdcfg_table[15].t});

      mux_m32_out = muxout (mux_m3_sel, {16'h0, iopmp_reg.mdcfg_table[16].t},  {16'h0, iopmp_reg.mdcfg_table[17].t}, {16'h0, iopmp_reg.mdcfg_table[18].t}, {16'h0, iopmp_reg.mdcfg_table[19].t},
                            {16'h0, iopmp_reg.mdcfg_table[20].t}, {16'h0, iopmp_reg.mdcfg_table[21].t}, {16'h0, iopmp_reg.mdcfg_table[22].t}, {16'h0, iopmp_reg.mdcfg_table[23].t});

      mux_m33_out = muxout (mux_m3_sel, {16'h0, iopmp_reg.mdcfg_table[24].t},  {16'h0, iopmp_reg.mdcfg_table[25].t}, {16'h0, iopmp_reg.mdcfg_table[26].t}, {16'h0, iopmp_reg.mdcfg_table[27].t},
                            {16'h0, iopmp_reg.mdcfg_table[28].t}, {16'h0, iopmp_reg.mdcfg_table[29].t}, {16'h0, iopmp_reg.mdcfg_table[30].t}, {16'h0, iopmp_reg.mdcfg_table[31].t});

      mux_m34_out = muxout (mux_m3_sel, {16'h0, iopmp_reg.mdcfg_table[32].t},  {16'h0, iopmp_reg.mdcfg_table[33].t}, {16'h0, iopmp_reg.mdcfg_table[34].t}, {16'h0, iopmp_reg.mdcfg_table[35].t},
                            {16'h0, iopmp_reg.mdcfg_table[36].t}, {16'h0, iopmp_reg.mdcfg_table[37].t}, {16'h0, iopmp_reg.mdcfg_table[38].t}, {16'h0, iopmp_reg.mdcfg_table[39].t});

      mux_m35_out = muxout (mux_m3_sel, {16'h0, iopmp_reg.mdcfg_table[40].t},  {16'h0, iopmp_reg.mdcfg_table[41].t}, {16'h0, iopmp_reg.mdcfg_table[42].t}, {16'h0, iopmp_reg.mdcfg_table[43].t},
                            {16'h0, iopmp_reg.mdcfg_table[44].t}, {16'h0, iopmp_reg.mdcfg_table[45].t}, {16'h0, iopmp_reg.mdcfg_table[46].t}, {16'h0, iopmp_reg.mdcfg_table[47].t});

      mux_m36_out = muxout (mux_m3_sel, {16'h0, iopmp_reg.mdcfg_table[48].t},  {16'h0, iopmp_reg.mdcfg_table[49].t}, {16'h0, iopmp_reg.mdcfg_table[50].t}, {16'h0, iopmp_reg.mdcfg_table[51].t},
                            {16'h0, iopmp_reg.mdcfg_table[52].t}, {16'h0, iopmp_reg.mdcfg_table[53].t}, {16'h0, iopmp_reg.mdcfg_table[54].t}, {16'h0, iopmp_reg.mdcfg_table[55].t});

      mux_m37_out = muxout (mux_m3_sel, {16'h0, iopmp_reg.mdcfg_table[56].t},  {16'h0, iopmp_reg.mdcfg_table[57].t}, {16'h0, iopmp_reg.mdcfg_table[58].t}, {16'h0, iopmp_reg.mdcfg_table[59].t},
                            {16'h0, iopmp_reg.mdcfg_table[60].t}, {16'h0, iopmp_reg.mdcfg_table[61].t}, {16'h0, iopmp_reg.mdcfg_table[62].t}, ILLEGAL);
    ...
    for (int j = 0; j < 8; j++) begin : entry_array_l4_mux_outer_loop
      for (int i = 0; i < 8; i++) begin : entry_array_l4_mux_inner_loop
        ea_l4_index = (i << 1) + (j << 4);
        mux_ea4_out[((j << 3) + i)] = muxout (mux_ea4_sel, iopmp_reg.entry_array[ea_l4_index].entry_addr, {14'h0, iopmp_reg.entry_array[ea_l4_index].entry_addrh}, {21'h0, iopmp_reg.entry_array[ea_l4_index].entry_cfg}, ILLEGAL,
                                              iopmp_reg.entry_array[ea_l4_index+1].entry_addr, {14'h0, iopmp_reg.entry_array[ea_l4_index+1].entry_addrh}, {21'h0, iopmp_reg.entry_array[ea_l4_index+1].entry_cfg}, ILLEGAL);
      end
    end
