...
module slave_req_mgr
  ...
  if (ERROR_CAPTURE_EN) begin : generate_msi_buf
    //--------------------------------------------------------------------------
  ...
  axi_write_chnl_controller axi_write_chnl_controller (
    ...
    .msi_vld             (ERROR_CAPTURE_EN ? eAwChannel.aw_id[5] : 1'b0),   // Indicates this is an MSI transaction
    ...
    .msi_req_buf_empty   (msi_req_buf_empty),                               // MSI Buffer Status
