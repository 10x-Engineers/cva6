...
module master_response_manager
  ...
  logic [1:0]                       prio;                       // Priority select/control signal
  ...
  always_comb begin : RRespCntrlr
    ...
    prio                = 2'b10;                 // Slave read response buffer has highest priority
    ...
    case (resp_state_q)
      ...
      ERR_RSP_ACTIVE: begin
        prio = 2'b01;  // Lower slave priority while read error burst is active
