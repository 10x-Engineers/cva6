...
#include <stdint.h>
#include <stdlib.h>
#include  "../../iopmp_top/vlib/dpi_defines.h"
#ifndef UVM_TEST
    #include "iopmp.h"
#else
    #include "../../iopmp_ref_model/include/iopmp.h"
#endif
...
extern void configure_mdlck(reg_intf_dw data, uint8_t num_bytes);
extern void configure_mdlckh(reg_intf_dw data, uint8_t num_bytes);
extern void configure_mdcfglck(reg_intf_dw data, uint8_t num_bytes);
extern void configure_entrylck(reg_intf_dw data, uint8_t num_bytes);
extern void configure_mdstall(reg_intf_dw data, uint8_t num_bytes);
extern void configure_mdstallh(reg_intf_dw data, uint8_t num_bytes);
extern void configure_rridscp(reg_intf_dw data, uint8_t num_bytes);
extern void configure_err_info(reg_intf_dw data, uint8_t num_bytes);
