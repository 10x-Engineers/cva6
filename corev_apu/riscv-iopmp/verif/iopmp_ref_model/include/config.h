...
#define IOPMP_PARIENT_PROG      1
#define IOPMP_RRID_TRANSL_EN    0
...
#define IOPMP_MD_ENTRY_NUM      0
#define IOPMP_MD_NUM            63          // Max 63 MD is supported
#define IOPMP_ADDRH_EN          1
#define IOPMP_ENABLE            0
#define IOPMP_ENTRY_NUM         128
#define IOPMP_PRIO_ENTRY        48
#define IOPMP_RRID_TRANSL       0
...
#define ENTRY_OFFSET            0x10000      // Offset for the entry table.
