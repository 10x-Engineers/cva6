...
void iopmp_validate_access(iopmp_trans_req_t *trans_req, iopmp_trans_rsp_t* iopmp_trans_rsp, uint8_t *intrpt) {
    // vpi_printf("Trans::::::::::::::::::rrid= %x\n", trans_req->rrid);
    // vpi_printf("Trans::::::::::::::::::addr= %x\n", trans_req->addr);
    // vpi_printf("Trans::::::::::::::::length= %x\n", trans_req->length);
    // vpi_printf("Trans::::::::::::::::::size= %x\n", trans_req->size);
    // vpi_printf("Trans::::::::::::::::::perm= %x\n", trans_req->perm);
    ...
    // Read SRCMD table based on `rrid`
            ...
            // vpi_printf("\n  rrid is %x srcmd_en:::::::::::: %x\n",trans_req->rrid,srcmd_en);
            srcmd_enh = g_reg_file.srcmd_table[trans_req->rrid].srcmd_enh;
            // vpi_printf("\n rrid is %x srcmd_enh:::::::::::: %x\n",trans_req->rrid,srcmd_enh);
        #endif
    #endif
