class dynamic_k_model_NA4_x_0x03_interrupt_enable extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_x_0x03_interrupt_enable)
  ...
  function new(string name = "dynamic_k_model_NA4_x_0x03_interrupt_enable", uvm_component parent = null);
