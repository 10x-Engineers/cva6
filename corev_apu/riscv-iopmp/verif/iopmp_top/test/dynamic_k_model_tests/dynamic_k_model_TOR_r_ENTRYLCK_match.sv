class dynamic_k_model_TOR_r_ENTRYLCK_match extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_TOR_r_ENTRYLCK_match)
  ...
  function new(string name = "dynamic_k_model_TOR_r_ENTRYLCK_match", uvm_component parent = null);
