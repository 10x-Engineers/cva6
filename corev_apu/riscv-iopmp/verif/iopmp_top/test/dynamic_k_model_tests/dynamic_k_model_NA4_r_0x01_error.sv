class dynamic_k_model_NA4_r_0x01_error extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_r_0x01_error)
  ...
  function new(string name = "dynamic_k_model_NA4_r_0x01_error", uvm_component parent = null);
