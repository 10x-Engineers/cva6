class dynamic_k_model_NA4_w_0x02_error_interrupt_suppress extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_w_0x02_error_interrupt_suppress)
  ...
  function new(string name = "dynamic_k_model_NA4_w_0x02_error_interrupt_suppress", uvm_component parent = null);
