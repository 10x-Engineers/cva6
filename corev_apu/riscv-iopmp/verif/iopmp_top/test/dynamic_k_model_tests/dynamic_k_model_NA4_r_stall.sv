class dynamic_k_model_NA4_r_stall extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_r_stall)
  ...
  function new(string name = "dynamic_k_model_NA4_r_stall", uvm_component parent = null);
