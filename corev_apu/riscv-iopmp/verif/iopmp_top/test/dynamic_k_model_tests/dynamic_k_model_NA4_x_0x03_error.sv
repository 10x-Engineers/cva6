class dynamic_k_model_NA4_x_0x03_error extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_x_0x03_error)
  ...
  function new(string name = "dynamic_k_model_NA4_x_0x03_error", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'h10;                     // NA4 address mode with no permissions granted
      entry_cfg.index = 12;
      entry_cfg.start(env.ahb_env.ahb_agnt.ahb_sqr);

      // Illegal Instruction Fetch Error on this transaction
      #50ns;
      ar_seq.rrid      = 32;
      ar_seq.addr      = 364;
      ar_seq.id        = 3;
