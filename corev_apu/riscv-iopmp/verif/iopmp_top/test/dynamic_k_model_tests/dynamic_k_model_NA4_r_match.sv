class dynamic_k_model_NA4_r_match extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_r_match)
  ...
  function new(string name = "dynamic_k_model_NA4_r_match", uvm_component parent = null);
