class dynamic_k_model_NA4_w_stall extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_w_stall)
  ...
  function new(string name = "dynamic_k_model_NA4_w_stall", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    ...
    phase.raise_objection(this, "MAIN - raise_objection");
     ...
     // hwcfg2.prio_entry = 16
      ...
      entry_cfg.wdata = 32'h13;                     // NA4 address mode with read write permissions granted
      entry_cfg.index = 10;
