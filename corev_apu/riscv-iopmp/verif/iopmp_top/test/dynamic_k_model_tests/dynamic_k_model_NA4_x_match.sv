class dynamic_k_model_NA4_x_match extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NA4_x_match)
  ...
  function new(string name = "dynamic_k_model_NA4_x_match", uvm_component parent = null);
