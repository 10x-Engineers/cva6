// Test MDLCK, updating unlocked srcmd_en field
class dynamic_k_model_NAPOT_x_MDLCK_match extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NAPOT_x_MDLCK_match)
  ...
  function new(string name = "dynamic_k_model_NAPOT_x_MDLCK_match", uvm_component parent = null);
