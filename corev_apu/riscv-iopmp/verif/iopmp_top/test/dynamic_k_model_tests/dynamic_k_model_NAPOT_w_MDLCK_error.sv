class dynamic_k_model_NAPOT_w_MDLCK_error extends dynamic_k_model_base_test;
  `uvm_component_utils(dynamic_k_model_NAPOT_w_MDLCK_error)
  ...
  function new(string name = "dynamic_k_model_NAPOT_w_MDLCK_error", uvm_component parent = null);
