class compact_k_model_TOR_x_ENTRYLCK_match extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_TOR_x_ENTRYLCK_match)
  ...
  function new(string name = "compact_k_model_TOR_x_ENTRYLCK_match", uvm_component parent = null);
