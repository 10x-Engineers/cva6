class compact_k_model_NA4_w_stall extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_NA4_w_stall)
  ...
  function new(string name = "compact_k_model_NA4_w_stall", uvm_component parent = null);
