class compact_k_model_NAPOT_w_0x02_interrupt_enable extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_NAPOT_w_0x02_interrupt_enable)
  ...
  function new(string name = "compact_k_model_NAPOT_w_0x02_interrupt_enable", uvm_component parent = null);
