class compact_k_model_NAPOT_x_0x03_interrupt_suppress extends compact_k_model_base_test;
  `uvm_component_utils(compact_k_model_NAPOT_x_0x03_interrupt_suppress)
  ...
  function new(string name = "compact_k_model_NAPOT_x_interrupt_suppress", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'h98;                     // NAPOT address mode with ixe suppression and no permissions granted
      entry_cfg.index = 9;
