...
class compact_k_model_base_test extends uvm_test;
    `uvm_component_utils(compact_k_model_base_test)
    ...
    function new(string name = "compact_k_model_base_test", uvm_component parent = null);
