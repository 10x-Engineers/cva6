/*************************************************************************
   > File Name:   test_ad2_program_prio_success.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_program_prio_success extends full_model_base_test;
    `uvm_component_utils(test_ad2_program_prio_success)
    ...
    function new(string name = "test_ad2_program_prio_success", uvm_component parent = null);
