class full_model_no_w_disable extends full_model_base_test;
  `uvm_component_utils(full_model_no_w_disable)
  ...
  function new(string name = "full_model_no_w_disable", uvm_component parent = null);
