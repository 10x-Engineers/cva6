/*************************************************************************
   > File Name:   full_model_NA4_illegal_read_interrupt_enable_sup.sv
   > Description: 
    1. Configure the IOPMP Registers.
    2. Configure the interrupt suppress bit for an illegal read access in the ENTRY_CFG Register.
    3. Congfigure the global interrupt enable.
    4. Send a read transaction that must generate 0x01 error.
  Also test this case, 
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_read_interrupt_enable_sup extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_read_interrupt_enable_sup)
  ...
  function new(string name = "full_model_NA4_illegal_read_interrupt_enable_sup", uvm_component parent = null);
