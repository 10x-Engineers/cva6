/*************************************************************************
   > File Name:   full_model_NA4_illegal_unknown_rrid_interrupt_enable_msi.sv
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_unknown_rrid_interrupt_enable_msi extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_unknown_rrid_interrupt_enable_msi)
  ...
  function new(string name = "full_model_NA4_illegal_unknown_rrid_interrupt_enable_msi", uvm_component parent = null);
