/*************************************************************************
   > File Name:   test_ad2_program_prio_pr_no_hit_1.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_program_prio_pr_no_hit_1 extends full_model_base_test;
    `uvm_component_utils(test_ad2_program_prio_pr_no_hit_1)
    ...
    function new(string name = "test_ad2_program_prio_pr_no_hit_1", uvm_component parent = null);
    ...
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      mdcfg.b_data = 32'h18;                          // 5 entries associated with this md   entry 0,1,2,3,4
      mdcfg.index = 1;
      mdcfg.start(env.reg_env.ahb_agnt.ahb_sqr);
      
      mdcfg.b_data = 32'h20;                          // 5 entries associated with this md   entry 0,1,2,3,4
      mdcfg.index = 2;
      mdcfg.start(env.reg_env.ahb_agnt.ahb_sqr);
     ...
     // entry associated = 18
      ...
      entry_cfg.b_data = 32'h11;                     // NA4 address mode with no permission granted
      entry_cfg.index = 18;
      ...
      hwcfg2.b_data = 32'h10;                   //Setting PRIO ENTRY 16
      ...
      hwcfg2.b_data = 32'h14;                   //Setting PRIO ENTRY 20
      hwcfg2.start(env.reg_env.ahb_agnt.ahb_sqr);
  ...
  endtask : main_phase
endclass //test_ad2_program_prio_err extends full_model_base_test