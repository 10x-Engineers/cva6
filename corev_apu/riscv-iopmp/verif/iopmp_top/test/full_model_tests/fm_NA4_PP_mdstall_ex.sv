/*************************************************************************
   > File Name:   fm_NA4_PP_mdstall_ex.sv
   > Description: Send read address for Full Model with NA4 Addressing mode with no permission in entry_cfg. Select MDs BY SETTING md field MDSTALL reg. Also set exempt to exclude those mds from stalling. Then send read transaction again.
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_PP_mdstall_ex extends full_model_base_test;
  `uvm_component_utils(fm_NA4_PP_mdstall_ex)
  ...
  function new(string name = "fm_NA4_PP_mdstall_ex", uvm_component parent = null);
