...
class full_model_x_MDLCKH_match extends full_model_base_test;
  `uvm_component_utils(full_model_x_MDLCKH_match)
  ...
  function new(string name = "full_model_x_MDLCKH_match", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'h1C;                     // NAPOT address mode with instruction fecth permission granted
      entry_cfg.index = 3;
