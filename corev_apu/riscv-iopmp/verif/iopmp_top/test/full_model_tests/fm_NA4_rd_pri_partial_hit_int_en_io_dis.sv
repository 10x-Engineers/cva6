/*************************************************************************
   > File Name:   fm_NA4_rd_pri_partial_hit_int_en_io_dis.sv
   > Description: 
   1. Configure the IOPMP Registers.
   2. Send a read/write/instruction fetch transaction that must generate 0x04 error.
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_rd_pri_partial_hit_int_en_io_dis extends full_model_base_test;
  `uvm_component_utils(fm_NA4_rd_pri_partial_hit_int_en_io_dis)
  ...
  function new(string name = "fm_NA4_rd_pri_partial_hit_int_en_io_dis", uvm_component parent = null);
