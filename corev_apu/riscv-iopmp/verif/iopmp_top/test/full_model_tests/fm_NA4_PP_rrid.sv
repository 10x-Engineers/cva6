/*************************************************************************
   > File Name:   fm_NA4_PP_rrid.sv
   > Description: Send read address for Full Model with NA4 Addressing mode with r permission in entry_cfg. Select RRIDs BY SETTING rrid field RRIDSCP reg. Also set OP =1 to stall those rrids. Then send read transaction again after removing read permission in entry_Cfg reg.
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_PP_rrid extends full_model_base_test;
  `uvm_component_utils(fm_NA4_PP_rrid)
  ...
  function new(string name = "fm_NA4_PP_rrid", uvm_component parent = null);
