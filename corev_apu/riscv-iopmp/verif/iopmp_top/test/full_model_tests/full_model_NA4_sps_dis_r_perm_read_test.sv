/*************************************************************************
   > File Name:   full_model_NA4_sps_dis_r_perm_read_test.sv
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_sps_dis_r_perm_read_test extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_sps_dis_r_perm_read_test)
  ...
  function new(string name = "full_model_NA4_sps_dis_r_perm_read_test", uvm_component parent = null);
