/*************************************************************************
   > File Name:   full_model_no_perm_write_test.sv
   > Description: Send read address for Full MOdel with NA4 Addressing mode with no permission in entry_cfg.
...
class full_model_no_perm_write_test extends full_model_base_test;
  `uvm_component_utils(full_model_no_perm_write_test)
  ...
  function new(string name = "full_model_no_perm_write_test", uvm_component parent = null);
