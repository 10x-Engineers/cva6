/*************************************************************************
   > File Name:   full_model_NA4_illegal_unknown_rrid_interrupt_enable.sv
   > Description: Send read address for Full MOdel with NA4 Addressing mode with read permission in entry_cfg. Also Enable interrupt enable bit in error capture register then check if interrupt is reported or not. Send request with unknown rrid.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_unknown_rrid_interrupt_enable extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_unknown_rrid_interrupt_enable)
  ...
  function new(string name = "full_model_NA4_illegal_unknown_rrid_interrupt_enable", uvm_component parent = null);
