/*************************************************************************
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_w_0x02_error extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_w_0x02_error)
  ...
  function new(string name = "full_model_NA4_w_0x02_error", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'h11;                     // NA4 address mode with write permission not granted and read permission granted
      entry_cfg.index = 17;
