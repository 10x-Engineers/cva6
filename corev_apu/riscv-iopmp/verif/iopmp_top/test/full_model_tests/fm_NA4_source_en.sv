/*************************************************************************
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_source_en extends full_model_base_test;
  `uvm_component_utils(fm_NA4_source_en)
  ...
  function new(string name = "fm_NA4_source_en", uvm_component parent = null);
