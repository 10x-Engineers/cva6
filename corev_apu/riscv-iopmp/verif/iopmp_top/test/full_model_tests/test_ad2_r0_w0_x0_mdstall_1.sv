/*************************************************************************
   > File Name:   test_ad2_r0_w0_x0_mdstall_1.sv
...
12. Write all zero's on MDSTALL register
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_r0_w0_x0_mdstall_1 extends full_model_base_test;
  `uvm_component_utils(test_ad2_r0_w0_x0_mdstall_1)
  ...
  function new(string name = "test_ad2_r0_w0_x0_mdstall_1", uvm_component parent = null);
...
//FOR MD = 0
      ...
      mdcfg.b_data = 32'h3;                          // 1 entrY associated with this md   entry 0
      mdcfg.index = 0;
...
//For MD = 1
      ...
      mdcfg.b_data = 32'h6;                          // 1 entries associated with this md   entry 1
      mdcfg.index = 1;
      mdcfg.start(env.reg_env.ahb_agnt.ahb_sqr);
      ...
      mdstall.b_data    = 32'h6;
      mdstall.start(env.axi_env.rd_addr_agnt.rd_addr_sqr);

      // rridscp.b_data    = 32'h40000005;
      // rridscp.start(env.axi_env.rd_addr_agnt.rd_addr_sqr);
...
//FOR MD = 2
      ...
      mdcfg.b_data = 32'h9;                          // 1 entrY associated with this md   entry 0
      mdcfg.index = 2;
      mdcfg.start(env.reg_env.ahb_agnt.ahb_sqr);
      ...
      entry_cfg.b_data = 32'h12;                     // NA4 address mode with no permission granted
      entry_cfg.index = 6;
      entry_cfg.start(env.reg_env.ahb_agnt.ahb_sqr);
      ...
      //
      entry_cfg.b_data = 32'h17;                     // NA4 address mode with read permission granted
      entry_cfg.index = 0;
      entry_cfg.start(env.reg_env.ahb_agnt.ahb_sqr);
