/*************************************************************************
   > File Name:   fm_NA4_rd_pri_partial_hit_int_en_msi.sv
   > Description: Send read address for Full Model with NA4 Addressing mode with read permission in entry_cfg. Set size of data such that it gives partial hit. Also Enable interrupt enable and msi_en bit in error capture register then check if interrupt is reported or not. Set entry priority
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_rd_pri_partial_hit_int_en_msi extends full_model_base_test;
  `uvm_component_utils(fm_NA4_rd_pri_partial_hit_int_en_msi)
  ...
  function new(string name = "fm_NA4_rd_pri_partial_hit_int_en_msi", uvm_component parent = null);
