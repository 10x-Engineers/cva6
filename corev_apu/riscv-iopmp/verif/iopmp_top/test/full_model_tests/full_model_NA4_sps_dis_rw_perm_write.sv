/*************************************************************************
   > File Name:   full_model_NA4_sps_dis_rw_perm_write.sv
...
class full_model_NA4_sps_dis_rw_perm_write extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_sps_dis_rw_perm_write)
  ...
  function new(string name = "full_model_NA4_sps_dis_rw_perm_write", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.b_data = 32'h13;                     // NA4 address mode with write permission granted
      entry_cfg.index = 5;
