/*************************************************************************
   ...
   > Description: Send read address for Full MOdel with NA4 Addressing mode with r permission in entry_cfg. Set srcmd then send the send axi read transaction then overwrite srcmd then send again read transc.
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_overwrite_srcmd_md_read extends full_model_base_test;
