/*************************************************************************
   > File Name:   full_model_NA4_illegal_inst_msi_interrupt_enable_sup.sv
   > Description: 
    ...
    4. Send a instruction fetch transaction to the IOPMP that should generate an error type 0x03.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_NA4_illegal_inst_msi_interrupt_enable_sup extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_illegal_inst_msi_interrupt_enable_sup)
  ...
  function new(string name = "full_model_NA4_illegal_inst_msi_interrupt_enable_sup", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
     ...
     // hwcfg2.prio_entry = 16
      ...
      entry_cfg.b_data   = 32'h90;                     // NA4 address mode with no permissions granted and sire enabled.
      entry_cfg.index    = 3;
