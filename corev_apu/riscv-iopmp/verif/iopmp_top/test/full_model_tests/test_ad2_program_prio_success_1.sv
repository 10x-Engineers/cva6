/*************************************************************************
   > File Name:   test_ad2_program_prio_success_1.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_program_prio_success_1 extends full_model_base_test;
    `uvm_component_utils(test_ad2_program_prio_success_1)
    ...
    function new(string name = "test_ad2_program_prio_success_1", uvm_component parent = null);
