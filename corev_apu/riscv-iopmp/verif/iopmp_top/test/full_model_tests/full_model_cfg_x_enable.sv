/*************************************************************************
   > File Name:   full_model_cfg_x_enable.sv
   > Description: Send read address with prot b100 for Full MOdel with NA4 Addressing mode by enabling x permission in entry_cfg.
...
class full_model_cfg_x_enable extends full_model_base_test;
  `uvm_component_utils(full_model_cfg_x_enable)
  ...
  function new(string name = "full_model_cfg_x_enable", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAINPHASE STARTED", UVM_LOW);
      ...
      entry_cfg.b_data = 32'h14;                     // NA4 address mode with instruction fetch permission granted
      entry_cfg.index = 3;
      ...
      // This transaction is a success as permissions are granted by entry_cfg.x
      #50;
      ar_seq.rrid                 = 32;
      ar_seq.seq_addr             = 364;
      ar_seq.seq_id               = 3;
