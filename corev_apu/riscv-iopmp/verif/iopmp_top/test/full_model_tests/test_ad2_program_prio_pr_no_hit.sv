/*************************************************************************
   > File Name:   test_ad2_program_prio_pr_no_hit.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_program_prio_pr_no_hit extends full_model_base_test;
    `uvm_component_utils(test_ad2_program_prio_pr_no_hit)
    ...
    function new(string name = "test_ad2_program_prio_pr_no_hit", uvm_component parent = null);
