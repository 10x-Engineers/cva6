/*************************************************************************
   > File Name:   fm_NA4_wr_pri_partial_hit_int_en.sv
   > Description: 
   Set entry addr to partial match and send transaction with write reqs with entry configured to be priority
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_wr_pri_partial_hit_int_en extends full_model_base_test;
  `uvm_component_utils(fm_NA4_wr_pri_partial_hit_int_en)
  ...
  function new(string name = "fm_NA4_wr_pri_partial_hit_int_en", uvm_component parent = null);
