class full_model_TOR_w_0x02_error extends full_model_base_test;
  `uvm_component_utils(full_model_TOR_w_0x02_error)
  ...
  function new(string name = "full_model_TOR_w_0x02_error", uvm_component parent = null);
