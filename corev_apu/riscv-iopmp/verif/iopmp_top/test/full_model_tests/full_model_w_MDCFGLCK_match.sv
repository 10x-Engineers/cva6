class full_model_w_MDCFGLCK_match extends full_model_base_test;
  `uvm_component_utils(full_model_w_MDCFGLCK_match)
  ...
  function new(string name = "full_model_w_MDCFGLCK_match", uvm_component parent = null);
