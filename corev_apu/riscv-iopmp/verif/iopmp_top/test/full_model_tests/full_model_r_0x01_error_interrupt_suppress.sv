class full_model_r_0x01_error_interrupt_suppress extends full_model_base_test;
  `uvm_component_utils(full_model_r_0x01_error_interrupt_suppress)
  ...
  function new(string name = "full_model_r_0x01_error_interrupt_suppress", uvm_component parent = null);
