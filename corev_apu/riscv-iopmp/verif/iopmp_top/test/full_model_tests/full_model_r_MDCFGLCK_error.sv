class full_model_r_MDCFGLCK_error extends full_model_base_test;
  `uvm_component_utils(full_model_r_MDCFGLCK_error)
  ...
  function new(string name = "full_model_r_MDCFGLCK_error", uvm_component parent = null);
