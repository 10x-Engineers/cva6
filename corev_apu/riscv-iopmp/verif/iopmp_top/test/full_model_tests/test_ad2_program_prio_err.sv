/*************************************************************************
   > File Name:   test_ad2_program_prio_err.sv
   > Description: 
   ...
   ---------------------------------------------------------------
************************************************************************/
class test_ad2_program_prio_err extends full_model_base_test;
    `uvm_component_utils(test_ad2_program_prio_err)
    ...
    function new(string name = "test_ad2_program_prio_err", uvm_component parent = null);
