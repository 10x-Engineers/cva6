/*************************************************************************
   > File Name:   full_model_r_perm_read_test.sv
   > Description: 
   1. Configure full address match with entry read permission = 1.
   2. Corresponding SRCMD_R bit is 1.
   3. Send a read transaction.
   ...
   ---------------------------------------------------------------
************************************************************************/
class full_model_r_perm_read_test extends full_model_base_test;
  `uvm_component_utils(full_model_r_perm_read_test)
  ...
  function new(string name = "full_model_r_perm_read_test", uvm_component parent = null);
