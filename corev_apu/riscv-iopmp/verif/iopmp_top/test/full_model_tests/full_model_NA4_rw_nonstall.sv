class full_model_NA4_rw_nonstall extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_rw_nonstall)
  ...
  function new(string name = "full_model_NA4_rw_nonstall", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      mdcfg.wdata = 64'h500000000;                    // 3 entries associated with this md   entry 3,4,5
      mdcfg.index = 3;
      mdcfg.start(env.ahb_env.ahb_agnt.ahb_sqr);
      ...
      mdcfg.wdata = 64'h700000000;                    // 3 entries associated with this md   entry 0,1,2
      mdcfg.index = 5;
      mdcfg.start(env.ahb_env.ahb_agnt.ahb_sqr);
