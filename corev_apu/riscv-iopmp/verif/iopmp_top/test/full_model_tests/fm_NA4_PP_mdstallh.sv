/*************************************************************************
   > File Name:   fm_NA4_PP_mdstallh.sv
   > Description: Send read address for Full Model with NA4 Addressing mode with no permission in entry_cfg.  Select MDs BY SETTING md field in MDSTALLh reg. Then send read transaction again.
   ...
   ---------------------------------------------------------------
************************************************************************/
class fm_NA4_PP_mdstallh extends full_model_base_test;
  `uvm_component_utils(fm_NA4_PP_mdstallh)
  ...
  function new(string name = "fm_NA4_PP_mdstallh", uvm_component parent = null);
