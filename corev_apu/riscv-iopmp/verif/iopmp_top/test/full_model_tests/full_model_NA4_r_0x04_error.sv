class full_model_NA4_r_0x04_error extends full_model_base_test;
  `uvm_component_utils(full_model_NA4_r_0x04_error)
  ...
  function new(string name = "full_model_NA4_r_0x04_error", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      mdcfg.b_data = 64'h300000000;                  // 3 entries associated with this md   entry 0,1,2
      mdcfg.index = 3;
