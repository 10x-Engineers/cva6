...
class isolation_model_base_test extends uvm_test;
    `uvm_component_utils(isolation_model_base_test)
    ...
    function new(string name = "isolation_model_base_test", uvm_component parent = null);
