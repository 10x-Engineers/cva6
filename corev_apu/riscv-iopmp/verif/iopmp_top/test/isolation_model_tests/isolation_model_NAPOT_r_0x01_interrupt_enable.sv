class isolation_model_NAPOT_r_0x01_interrupt_enable extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_NAPOT_r_0x01_interrupt_enable)
  ...
  function new(string name = "isolation_model_NAPOT_r_0x01_interrupt_enable", uvm_component parent = null);
