class isolation_model_NAPOT_r_0x01_error extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_NAPOT_r_0x01_error)
  ...
  function new(string name = "isolation_model_NAPOT_r_0x01_error", uvm_component parent = null);
