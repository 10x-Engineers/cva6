class isolation_model_TOR_w_0x04_error extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_TOR_w_0x04_error)
  ...
  function new(string name = "isolation_model_TOR_w_0x04_error", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'h9;                      // TOR address mode with write permission not granted and read permission granated
      entry_cfg.index = 6;
