class isolation_model_NA4_w_stall extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_NA4_w_stall)
  ...
  function new(string name = "isolation_model_NA4_w_stall", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      mdcfg.wdata=64'h500000000; //2 entries associated with this md   entry 0,1
      mdcfg.index=30;      // 3 - 1 =2 index
