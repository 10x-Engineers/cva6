class isolation_model_NAPOT_x_0x03_error_suppress extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_NAPOT_x_0x03_error_suppress)
  ...
  function new(string name = "isolation_model_NAPOT_x_0x03_error_suppress", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      entry_cfg.wdata = 32'h418;                     // NAPOT address mode with exe suppression and no permissions granted
      entry_cfg.index = 5;
