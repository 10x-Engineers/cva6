class isolation_model_TOR_w_MDCFGLCK_error extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_TOR_w_MDCFGLCK_error)
  ...
  function new(string name = "isolation_model_TOR_w_MDCFGLCK_error", uvm_component parent = null);
  ...
  task main_phase(uvm_phase phase);
    `uvm_info(get_name(), "MAIN PHASE STARTED", UVM_LOW);
      ...
      // 4 mdcfg registers (0,1,2,3) are locked
