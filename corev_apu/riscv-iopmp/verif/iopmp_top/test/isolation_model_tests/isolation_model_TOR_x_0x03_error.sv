class isolation_model_TOR_x_0x03_error extends isolation_model_base_test;
  `uvm_component_utils(isolation_model_TOR_x_0x03_error)
  ...
  function new(string name = "isolation_model_TOR_x_0x03_error", uvm_component parent = null);
