class rapid_k_model_NA4_w_0x02_interrupt_enable extends rapid_k_model_base_test;
  `uvm_component_utils(rapid_k_model_NA4_w_0x02_interrupt_enable)
  ...
  function new(string name = "rapid_k_model_NA4_w_0x02_interrupt_enable", uvm_component parent = null);
