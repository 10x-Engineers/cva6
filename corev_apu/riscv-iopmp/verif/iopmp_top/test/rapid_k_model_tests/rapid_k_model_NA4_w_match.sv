class rapid_k_model_NA4_w_match  extends rapid_k_model_base_test;
  `uvm_component_utils(rapid_k_model_NA4_w_match )
  ...
  function new(string name = "rapid_k_model_NA4_w_match ", uvm_component parent = null);
