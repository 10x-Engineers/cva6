...
// Addrmap - iopmp_reg
    class iopmp_reg extends uvm_reg_block;
        ...
        rand iopmp_reg__srcmd_en srcmd_en_63;
        rand iopmp_reg__srcmd_enh srcmd_enh_63;
        rand iopmp_reg__srcmd_r srcmd_r_63;
        rand iopmp_reg__srcmd_rh srcmd_rh_63;
        rand iopmp_reg__srcmd_w srcmd_w_63;
        rand iopmp_reg__srcmd_wh srcmd_wh_63;
        ...
        virtual function void build();
            ...
            this.srcmd_en_63 = new("srcmd_en_63");
            this.srcmd_en_63.configure(this);

            this.srcmd_en_63.build();
            this.default_map.add_reg(this.srcmd_en_63, BASE_ADDR+'h17c0);
            this.srcmd_enh_63 = new("srcmd_enh_63");
            this.srcmd_enh_63.configure(this);

            this.srcmd_enh_63.build();
            this.default_map.add_reg(this.srcmd_enh_63, BASE_ADDR+'h17c4);
            this.srcmd_r_63 = new("srcmd_r_63");
            this.srcmd_r_63.configure(this);

            this.srcmd_r_63.build();
            this.default_map.add_reg(this.srcmd_r_63, BASE_ADDR+'h17c8);
            this.srcmd_rh_63 = new("srcmd_rh_63");
            this.srcmd_rh_63.configure(this);

            this.srcmd_rh_63.build();
            this.default_map.add_reg(this.srcmd_rh_63, BASE_ADDR+'h17cc);
            this.srcmd_w_63 = new("srcmd_w_63");
            this.srcmd_w_63.configure(this);

            this.srcmd_w_63.build();
            this.default_map.add_reg(this.srcmd_w_63, BASE_ADDR+'h17d0);
            this.srcmd_wh_63 = new("srcmd_wh_63");
            this.srcmd_wh_63.configure(this);

            this.srcmd_wh_63.build();
            this.default_map.add_reg(this.srcmd_wh_63, BASE_ADDR+'h17d4);
