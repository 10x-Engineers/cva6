...
# DVE full session
# Saved on Thu Feb 1 16:44:28 2024
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 152} {height 443} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 152} {height 443} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1365} {height 157} {dock_state bottom} {dock_on_new_line true}}
...
set _session_group_21 tlb_vif
gui_sg_create "$_session_group_21"
set tlb_vif "$_session_group_21"

gui_sg_addsignal -group "$_session_group_21" { top.tlb_vif.flush_i top.tlb_vif.lu_asid_i top.tlb_vif.lu_content_o top.tlb_vif.lu_vaddr_i top.tlb_vif.update_i top.tlb_vif.lu_hit_o {top.tlb_vif.$unit} top.tlb_vif.clk_i top.DUT.lu_hit top.DUT.replace_en top.DUT.tags_q top.DUT.content_q }
...
catch {gui_list_expand -id ${Hier.1} top.tlb_vif}
catch {gui_list_select -id ${Hier.1} {top.tlb_vif.DRIV}}
...
gui_list_show_data -id ${Data.1} {top.tlb_vif.DRIV}
